...
// External input
typedef struct {
} dq_statcom_react_ctrl_ExtIn;


// External output
typedef struct {
} dq_statcom_react_ctrl_ExtOut;

// Sinks
typedef struct {
    // Generated from the component: dq_STATCOM_react_ctrl.is_d_ref.in
    real_t _dq_statcom_react_ctrl_is_d_ref_in;
    // Generated from the component: dq_STATCOM_react_ctrl.is_q_ref.in
    real_t _dq_statcom_react_ctrl_is_q_ref_in;
} dq_statcom_react_ctrl_ModelSinks;
...
typedef struct {
    ...
    real_t _dq_statcom_react_ctrl_delay1__state[1];
    uint_t _dq_statcom_react_ctrl_delay1__cbi;

    // Generated from the component: dq_STATCOM_react_ctrl.SCI Receive1.advanced c function
    real_t _dq_statcom_react_ctrl_sci_receive1_advanced_c_function__state_var[4];
    ...
    real_t _dq_statcom_react_ctrl_rate_limiter1__state;
    int_t _dq_statcom_react_ctrl_rate_limiter1__first_step;
    ...
    real_t _dq_statcom_react_ctrl_c_function_pi_voltage_controller__y_dc;

    real_t _dq_statcom_react_ctrl_c_function_pi_voltage_controller__e_dc;




    // Generated from the component: dq_STATCOM_react_ctrl.C function powers
    real_t _dq_statcom_react_ctrl_c_function_powers__p_fil;

    real_t _dq_statcom_react_ctrl_c_function_powers__q_fil;




    // Generated from the component: dq_STATCOM_react_ctrl.C function PLL
    real_t _dq_statcom_react_ctrl_c_function_pll__y_q;

    real_t _dq_statcom_react_ctrl_c_function_pll__theta;




    // Generated from the component: dq_STATCOM_react_ctrl.C function1
    real_t _dq_statcom_react_ctrl_c_function1__y_qref;

    real_t _dq_statcom_react_ctrl_c_function1__e_qref;
    ...
    real_t _dq_statcom_react_ctrl_c_function_pi_current_controller__y_d;

    real_t _dq_statcom_react_ctrl_c_function_pi_current_controller__y_q;

    real_t _dq_statcom_react_ctrl_c_function_pi_current_controller__e_d;

    real_t _dq_statcom_react_ctrl_c_function_pi_current_controller__e_q;
...
} dq_statcom_react_ctrl_ModelStates;

// Model data structure
typedef struct {
    dq_statcom_react_ctrl_ExtIn *p_extIn;
    dq_statcom_react_ctrl_ExtOut *p_extOut;
    dq_statcom_react_ctrl_ModelSinks *p_Sinks;
    dq_statcom_react_ctrl_ModelStates *p_States;
} dq_statcom_react_ctrl_ModelData;

// External input
extern dq_statcom_react_ctrl_ExtIn dq_statcom_react_ctrl_ext_In;

// External output
extern dq_statcom_react_ctrl_ExtOut dq_statcom_react_ctrl_ext_Out;

// Sinks
extern dq_statcom_react_ctrl_ModelSinks dq_statcom_react_ctrl_m_Sinks;

// States
extern dq_statcom_react_ctrl_ModelStates dq_statcom_react_ctrl_m_States;

// Model data structure
extern dq_statcom_react_ctrl_ModelData dq_statcom_react_ctrl_m_Data;

// Model entry point functions
// Execution rate: 5e-05
extern void dq_statcom_react_ctrl_init0(dq_statcom_react_ctrl_ModelData *p_m_Data);
extern void dq_statcom_react_ctrl_step0(dq_statcom_react_ctrl_ModelData *p_m_Data);
// Execution rate: 0.001
extern void dq_statcom_react_ctrl_init1(dq_statcom_react_ctrl_ModelData *p_m_Data);
extern void dq_statcom_react_ctrl_step1(dq_statcom_react_ctrl_ModelData *p_m_Data);
