...
double _low_pass_filter1__previous_filtered_value;
...
double _deg2rad2__out;
double _ti_exp_adc__generic_1_12_bit_to_refv__out;
X_UnInt32 _ti_exp_epwm__generic_1_epwm_1_advanced_c_function__CMPA;
...
double _ti_exp_adc__generic_1_scaling__out;
double _ti_exp_sum19__out;
double _ti_exp_pid_controller3__out;
double _ti_exp_pid_controller3__pi_reg_out_int;
double _ti_exp_rad2deg__out;
double _ti_exp_limit3__out;
double _ti_exp_gain10__out;
double _ti_exp_sum20__out;
...
double _ti_exp_pid_controller3__filter_state;
X_Int32 _ti_exp_pid_controller3__reset_state;
double _ti_exp_epwm__generic_1_deg_to_tbphs_4_deg_to_tbphs__in_fmd;
...
//////////////////////////////////////////////////////////////////////////
    ...
    {
        _ti_exp_epwm__generic_1_deg_to_tbphs_2_deg_to_tbphs__in_fmd = fmod ( _ti_exp_epwm__generic_1_deg_to_tbphs_2_deg_to_tbphs__in , 360 ) ;
        _ti_exp_epwm__generic_1_deg_to_tbphs_2_deg_to_tbphs__target_angle = ( _ti_exp_epwm__generic_1_deg_to_tbphs_2_deg_to_tbphs__in_fmd < 0 ? _ti_exp_epwm__generic_1_deg_to_tbphs_2_deg_to_tbphs__in_fmd + 360 : _ti_exp_epwm__generic_1_deg_to_tbphs_2_deg_to_tbphs__in_fmd ) ;
        if ( _ti_exp_epwm__generic_1_deg_to_tbphs_2_deg_to_tbphs__target_angle < 180 )     {
            _ti_exp_epwm__generic_1_deg_to_tbphs_2_deg_to_tbphs__phsdir = 1 ;
            _ti_exp_epwm__generic_1_deg_to_tbphs_2_deg_to_tbphs__delay = 2 ;
        }
        else     {
            _ti_exp_epwm__generic_1_deg_to_tbphs_2_deg_to_tbphs__target_angle = 360 - _ti_exp_epwm__generic_1_deg_to_tbphs_2_deg_to_tbphs__target_angle ;
    ...
    {
        _ti_exp_epwm__generic_1_deg_to_tbphs_4_deg_to_tbphs__in_fmd = fmod ( _ti_exp_epwm__generic_1_deg_to_tbphs_4_deg_to_tbphs__in , 360 ) ;
        _ti_exp_epwm__generic_1_deg_to_tbphs_4_deg_to_tbphs__target_angle = ( _ti_exp_epwm__generic_1_deg_to_tbphs_4_deg_to_tbphs__in_fmd < 0 ? _ti_exp_epwm__generic_1_deg_to_tbphs_4_deg_to_tbphs__in_fmd + 360 : _ti_exp_epwm__generic_1_deg_to_tbphs_4_deg_to_tbphs__in_fmd ) ;
        if ( _ti_exp_epwm__generic_1_deg_to_tbphs_4_deg_to_tbphs__target_angle < 180 )     {
            _ti_exp_epwm__generic_1_deg_to_tbphs_4_deg_to_tbphs__phsdir = 1 ;
            _ti_exp_epwm__generic_1_deg_to_tbphs_4_deg_to_tbphs__delay = 2 ;
        }
        else     {
            _ti_exp_epwm__generic_1_deg_to_tbphs_4_deg_to_tbphs__target_angle = 360 - _ti_exp_epwm__generic_1_deg_to_tbphs_4_deg_to_tbphs__target_angle ;
    ...
    {
        _ti_exp_epwm__generic_1_deg_to_tbphs_3_deg_to_tbphs__in_fmd = fmod ( _ti_exp_epwm__generic_1_deg_to_tbphs_3_deg_to_tbphs__in , 360 ) ;
        _ti_exp_epwm__generic_1_deg_to_tbphs_3_deg_to_tbphs__target_angle = ( _ti_exp_epwm__generic_1_deg_to_tbphs_3_deg_to_tbphs__in_fmd < 0 ? _ti_exp_epwm__generic_1_deg_to_tbphs_3_deg_to_tbphs__in_fmd + 360 : _ti_exp_epwm__generic_1_deg_to_tbphs_3_deg_to_tbphs__in_fmd ) ;
        if ( _ti_exp_epwm__generic_1_deg_to_tbphs_3_deg_to_tbphs__target_angle < 180 )     {
            _ti_exp_epwm__generic_1_deg_to_tbphs_3_deg_to_tbphs__phsdir = 1 ;
            _ti_exp_epwm__generic_1_deg_to_tbphs_3_deg_to_tbphs__delay = 2 ;
        }
        else     {
            _ti_exp_epwm__generic_1_deg_to_tbphs_3_deg_to_tbphs__target_angle = 360 - _ti_exp_epwm__generic_1_deg_to_tbphs_3_deg_to_tbphs__target_angle ;
...
//@cmp.out.block.end
    ...
    // Generated from the component: ti_exp.PID controller3
    if (((_ti_exp_gpio___hil_do1_gpio_di_advanced_c_function__out > 0.0) && (_ti_exp_pid_controller3__reset_state <= 0)) || ((_ti_exp_gpio___hil_do1_gpio_di_advanced_c_function__out <= 0.0) && (_ti_exp_pid_controller3__reset_state == 1))) {
        _ti_exp_pid_controller3__integrator_state = 0.0;
        _ti_exp_pid_controller3__filter_state = 0.0;
    }
