...
double _pid_controller3__out;
double _pid_controller3__pi_reg_out_int;
double _rad2deg__out;
double _limit3__out;
double _gain10__out;
double _sum20__out;
...
double _pid_controller3__filter_state;
double _pid_controller3__reset_state;//@cmp.svar.end
...
//@cmp.out.block.end
    ...
    if (_step2__state <= 0.015)
        _step2__state += 5e-05;
    // Generated from the component: PID controller3
    if (((_constant18__out > 0.0) && (_pid_controller3__reset_state <= 0)) || ((_constant18__out <= 0.0) && (_pid_controller3__reset_state == 1))) {
        _pid_controller3__integrator_state = 0.0;
        _pid_controller3__filter_state = 0.0;
    }
