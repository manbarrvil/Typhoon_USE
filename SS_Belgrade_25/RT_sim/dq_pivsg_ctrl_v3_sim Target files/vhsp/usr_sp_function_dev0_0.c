...
X_UnInt32 _scada_rate_transition25_output__out;
X_UnInt32 _scada_rate_transition26_output__out;
double _scada_rate_transition27_output__out;
double _scada_rate_transition28_output__out;
...
double _controller_bus_split1__out;
double _controller_bus_split1__out1;
...
double _controller_c_function_vsg__time;
...
double _controller_bus_join14__out[2];
double _scada_bus_split2__out;
double _scada_bus_split2__out1;
double _scada_gain1__out;
double _scada_gain3__out;
double _scada_gain4__out;
...
//@cmp.svar.start
// state variables
X_UnInt32 _scada_rate_transition25_output__state;
X_UnInt32 _scada_rate_transition26_output__state;
double _scada_rate_transition27_output__state;
double _scada_rate_transition28_output__state;
...
void ReInit_user_sp_cpu0_dev0() {
    ...
    _scada_rate_transition25_output__state = (X_UnInt32) 0.0;
    _scada_rate_transition26_output__state = (X_UnInt32) 0.0;
    _scada_rate_transition27_output__state =  0.0;
    _scada_rate_transition28_output__state =  0.0;
...
//////////////////////////////////////////////////////////////////////////
    ...
    // Generated from the component: SCADA.Rate Transition25.Output
    _scada_rate_transition25_output__out = _scada_rate_transition25_output__state;
    // Generated from the component: SCADA.Rate Transition26.Output
    _scada_rate_transition26_output__out = _scada_rate_transition26_output__state;
    // Generated from the component: SCADA.Rate Transition27.Output
    _scada_rate_transition27_output__out = _scada_rate_transition27_output__state;
    // Generated from the component: SCADA.Rate Transition28.Output
    _scada_rate_transition28_output__out = _scada_rate_transition28_output__state;
    ...
    _controller_bus_join12__out[2] = _plant_is_c_ia1__out;
    ...
    _controller_bus_join13__out[0] = _plant_vs_a_va1__out;
    _controller_bus_join13__out[1] = _plant_vs_b_va1__out;
    _controller_bus_join13__out[2] = _plant_vs_c_va1__out;
    ...
    _controller_c_function_vsg__is_abc[0] = _controller_bus_join12__out[0];
    _controller_c_function_vsg__is_abc[1] = _controller_bus_join12__out[1];
    _controller_c_function_vsg__is_abc[2] = _controller_bus_join12__out[2];
    _controller_c_function_vsg__p_m_ref = _controller_bus_split1__out;
    _controller_c_function_vsg__q_s_ref = _controller_bus_split1__out1;
    _controller_c_function_vsg__time = _scada_rate_transition26_output__out;
    _controller_c_function_vsg__vs_abc[0] = _controller_bus_join13__out[0];
    _controller_c_function_vsg__vs_abc[1] = _controller_bus_join13__out[1];
    _controller_c_function_vsg__vs_abc[2] = _controller_bus_join13__out[2];
    {
        ...
        _controller_c_function_vsg__omega_vsg = ( 0.01 * _controller_c_function_vsg__e_p + _controller_c_function_vsg__x_p + 1.0 ) * 2.0 * M_PI * 50.0 ;
        ...
        _controller_c_function_vsg__is_dq_ref [ 0 ] = - 40.824829046386306 * ( 0.1 * _controller_c_function_vsg__e + 0.0 * _controller_c_function_vsg__vs_d / 326.5986323710904 + 0.1 * _controller_c_function_vsg__vs_q / 326.5986323710904 ) / ( pow ( 0.0 , 2 ) + pow ( 0.1 , 2 ) ) ;
        _controller_c_function_vsg__is_dq_ref [ 1 ] = - 40.824829046386306 * ( 0.0 * _controller_c_function_vsg__e + 0.0 * _controller_c_function_vsg__vs_q / 326.5986323710904 - 0.1 * _controller_c_function_vsg__vs_d / 326.5986323710904 ) / ( pow ( 0.0 , 2 ) + pow ( 0.1 , 2 ) ) ;
    ...
    _controller_bus_join11__out[0] = _controller_c_function_vsg__vs_d;
    _controller_bus_join11__out[1] = _controller_c_function_vsg__vs_q;
    // Generated from the component: Controller.Bus Join14
    _controller_bus_join14__out[0] = _controller_c_function_vsg__is_d;
    _controller_bus_join14__out[1] = _controller_c_function_vsg__is_q;
    // Generated from the component: SCADA.Bus Split2
    _scada_bus_split2__out = _controller_c_function_vsg__is_dq_ref_fil[0];
    _scada_bus_split2__out1 = _controller_c_function_vsg__is_dq_ref_fil[1];
    // Generated from the component: SCADA.Gain1
    _scada_gain1__out = 0.15915494309189535 * _controller_c_function_vsg__omega_vsg;
    // Generated from the component: SCADA.Gain3
    _scada_gain3__out = 20000.0 * _controller_c_function_vsg__p_s;
    ...
    _controller_c_function_pi_current_controller__is_dq[0] = _controller_bus_join14__out[0];
    _controller_c_function_pi_current_controller__is_dq[1] = _controller_bus_join14__out[1];
    _controller_c_function_pi_current_controller__is_dq_ref[0] = _controller_c_function_vsg__is_dq_ref_fil[0];
    _controller_c_function_pi_current_controller__is_dq_ref[1] = _controller_c_function_vsg__is_dq_ref_fil[1];
    _controller_c_function_pi_current_controller__omega_pll = _controller_c_function_vsg__omega_vsg;
    _controller_c_function_pi_current_controller__time = _scada_rate_transition26_output__out;
    _controller_c_function_pi_current_controller__v_dc = _plant_vdc_va1__out;
    _controller_c_function_pi_current_controller__vs_dq[0] = _controller_bus_join11__out[0];
    _controller_c_function_pi_current_controller__vs_dq[1] = _controller_bus_join11__out[1];
    {
    ...
    _controller_c_function_dq_to_abc__theta = _controller_c_function_vsg__theta_vsg;
    {
...
//@cmp.out.block.end
    ...
    // Generated from the component: Controller.C function VSG
    {
        ...
        _controller_c_function_vsg__x_q = _controller_c_function_vsg__x_q + 10.0 * 5e-05 * _controller_c_function_vsg__e_q ;
        ...
        if ( _controller_c_function_vsg__theta < 0.0 )     {
            _controller_c_function_vsg__theta = _controller_c_function_vsg__theta + abs ( _controller_c_function_vsg__theta ) ;
        }
...
//////////////////////////////////////////////////////////////////////////
    ...
    _scada_rate_transition27_output__state = _scada_qref__out;
    // Generated from the component: SCADA.Rate Transition26.Input
    _scada_rate_transition26_output__state = _scada_startac__out;
    // Generated from the component: SCADA.Rate Transition25.Input
    _scada_rate_transition25_output__state = _scada_startfsm__out;
//@cmp.out.block.end
    //////////////////////////////////////////////////////////////////////////
    // Update block
    //////////////////////////////////////////////////////////////////////////
