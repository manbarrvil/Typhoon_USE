...
*
* Code generated from model             : 'dq_current_ctrl_v2'.
* Subsystem selected for code generation: 'dq_current_ctrl'.
*
* Schematic Editor version              : 2025.2
* C source code generated on            : 24-Jul-2025 @ 12:52:25 PM
*
...
void dq_current_ctrl_step0(dq_current_ctrl_ModelData *p_m_Data) {
    ...
    {
        _dq_current_ctrl_epwm__generic_2_d_to_cmpa_1_d_to_cmpa__out = _dq_current_ctrl_epwm__generic_2_d_to_cmpa_1_d_to_cmpa__in * 10000 ;
    }
