...
//@cmp.var.start
// variables
double _constant1__out = 230.0;
double _controller_clock2__out;
double _controller_constant1__out = 0.0;
double _controller_constant2__out = 314.1592653589793;
...
double _controller_unit_delay6__out;
...
double _controller_governor_a__omega_nom;
double _controller_governor_a__omega_vsg;

double _controller_governor_a__p_prim;

double _controller_governor_b__omega_nom;
double _controller_governor_b__omega_vsg;

double _controller_governor_b__p_prim;

double _controller_governor_c__omega_nom;
double _controller_governor_c__omega_vsg;

double _controller_governor_c__p_prim;
...
double _controller_avr_b__voltage_non;
double _controller_avr_b__vs;

double _controller_avr_b__q_prim;

double _single_phase_power_meter2_calc_s__out;
double _controller_avr_a__voltage_non;
double _controller_avr_a__vs;

double _controller_avr_a__q_prim;
...
double _controller_avr_c__voltage_non;
double _controller_avr_c__vs;

double _controller_avr_c__q_prim;
...
double _controller_unit_delay6__state;
...
double _controller_governor_a__x_p;

double _controller_governor_a__e_p;




double _controller_governor_b__x_p;

double _controller_governor_b__e_p;




double _controller_governor_c__x_p;

double _controller_governor_c__e_p;
...
double _controller_rms_value2__filtered_value;
...
double _controller_rms_value1__filtered_value;
...
double _controller_rms_value3__filtered_value;
...
double _controller_avr_b__x_q;

double _controller_avr_b__e_q;




double _controller_avr_a__x_q;

double _controller_avr_a__e_q;
...
double _controller_avr_c__x_q;

double _controller_avr_c__e_q;
...
void ReInit_user_sp_cpu0_dev0() {
    ...
    _controller_unit_delay6__state = 0.0;
    ...
    {
        _controller_governor_a__x_p = 0.0 ;
        _controller_governor_a__e_p = 0.0 ;
    }
    {
        _controller_governor_b__x_p = 0.0 ;
        _controller_governor_b__e_p = 0.0 ;
    }
    {
        _controller_governor_c__x_p = 0.0 ;
        _controller_governor_c__e_p = 0.0 ;
    }
    ...
    _controller_rms_value2__filtered_value = 0x0;
    _controller_rms_value2__db_timer = 0x0;
    ...
    _controller_rms_value1__filtered_value = 0x0;
    _controller_rms_value1__db_timer = 0x0;
    ...
    _controller_rms_value3__filtered_value = 0x0;
    _controller_rms_value3__db_timer = 0x0;
    ...
    {
        _controller_avr_b__x_q = 0.0 ;
        _controller_avr_b__e_q = 0.0 ;
    }
    {
        _controller_avr_a__x_q = 0.0 ;
        _controller_avr_a__e_q = 0.0 ;
    }
    {
    ...
    {
        _controller_avr_c__x_q = 0.0 ;
        _controller_avr_c__e_q = 0.0 ;
    }
...
//////////////////////////////////////////////////////////////////////////
    ...
    // Generated from the component: Controller.Unit Delay6
    _controller_unit_delay6__out = _controller_unit_delay6__state;
    ...
    // Generated from the component: cont
    _cont__out = XIo_InFloat(0x2f800000);
    // Generated from the component: freq
    _freq__out = XIo_InFloat(0x2f800004);
    // Generated from the component: p_m_a_ref
    _p_m_a_ref__out = XIo_InFloat(0x2f800008);
    // Generated from the component: p_m_b_ref
    _p_m_b_ref__out = XIo_InFloat(0x2f80000c);
    // Generated from the component: p_m_c_ref
    _p_m_c_ref__out = XIo_InFloat(0x2f800010);
    // Generated from the component: q_s_a_ref
    _q_s_a_ref__out = XIo_InFloat(0x2f800014);
    // Generated from the component: q_s_b_ref
    _q_s_b_ref__out = XIo_InFloat(0x2f800018);
    // Generated from the component: q_s_c_ref
    _q_s_c_ref__out = XIo_InFloat(0x2f80001c);
    // Generated from the component: Controller.Governor_a
    _controller_governor_a__omega_nom = _controller_constant2__out;
    _controller_governor_a__omega_vsg = _controller_unit_delay4__out;
    {
        _controller_governor_a__p_prim = _controller_governor_a__e_p * 1 / 0.05 + _controller_governor_a__x_p ;
    }
    // Generated from the component: Controller.Governor_b
    _controller_governor_b__omega_nom = _controller_constant2__out;
    _controller_governor_b__omega_vsg = _controller_unit_delay5__out;
    {
        _controller_governor_b__p_prim = _controller_governor_b__e_p * 1 / 0.05 + _controller_governor_b__x_p ;
    }
    // Generated from the component: Controller.Governor_c
    _controller_governor_c__omega_nom = _controller_constant2__out;
    _controller_governor_c__omega_vsg = _controller_unit_delay6__out;
    {
        _controller_governor_c__p_prim = _controller_governor_c__e_p * 1 / 0.05 + _controller_governor_c__x_p ;
    }
    ...
    HIL_OutAO(0x4020, (float)_plant_is_a_ia1__out);
    // Generated from the component: is_n
    HIL_OutAO(0x4023, (float)_plant_is_a1_ia1__out);
    ...
    HIL_OutAO(0x4021, (float)_plant_is_b_ia1__out);
    ...
    HIL_OutAO(0x4022, (float)_plant_is_c_ia1__out);
    // Generated from the component: Controller.RMS value2
    _controller_rms_value2__previous_filtered_value = _controller_rms_value2__filtered_value;
    if (0)
        _controller_rms_value2__filtered_value = _controller_rms_value2__previous_filtered_value * 1 + _plant_v_sb_va1__out * 1;
    else
        _controller_rms_value2__filtered_value = _controller_rms_value2__previous_filtered_value * 0.1 + _plant_v_sb_va1__out * 0.9;
    _controller_rms_value2__db_timer += 5e-05;
    if( (_controller_rms_value2__filtered_value >= 0.0) && (_controller_rms_value2__previous_filtered_value < 0.0) && (_controller_rms_value2__db_timer >= 0.0) ) {
        _controller_rms_value2__zc = 1;
        _controller_rms_value2__db_timer = 0;
    } else
        _controller_rms_value2__zc = 0;
    ...
    HIL_OutAO(0x4027, (float)_plant_v_sb_va1__out);
    // Generated from the component: Controller.RMS value1
    _controller_rms_value1__previous_filtered_value = _controller_rms_value1__filtered_value;
    if (0)
        _controller_rms_value1__filtered_value = _controller_rms_value1__previous_filtered_value * 1 + _plant_vs_a_va1__out * 1;
    else
        _controller_rms_value1__filtered_value = _controller_rms_value1__previous_filtered_value * 0.1 + _plant_vs_a_va1__out * 0.9;
    _controller_rms_value1__db_timer += 5e-05;
    if( (_controller_rms_value1__filtered_value >= 0.0) && (_controller_rms_value1__previous_filtered_value < 0.0) && (_controller_rms_value1__db_timer >= 0.0) ) {
        _controller_rms_value1__zc = 1;
        _controller_rms_value1__db_timer = 0;
    } else
        _controller_rms_value1__zc = 0;
    ...
    HIL_OutAO(0x4026, (float)_plant_vs_a_va1__out);
    ...
    _controller_rms_value3__previous_filtered_value = _controller_rms_value3__filtered_value;
    if (0)
        _controller_rms_value3__filtered_value = _controller_rms_value3__previous_filtered_value * 1 + _plant_vs_c_va1__out * 1;
    else
        _controller_rms_value3__filtered_value = _controller_rms_value3__previous_filtered_value * 0.1 + _plant_vs_c_va1__out * 0.9;
    _controller_rms_value3__db_timer += 5e-05;
    if( (_controller_rms_value3__filtered_value >= 0.0) && (_controller_rms_value3__previous_filtered_value < 0.0) && (_controller_rms_value3__db_timer >= 0.0) ) {
        _controller_rms_value3__zc = 1;
        _controller_rms_value3__db_timer = 0;
    } else
        _controller_rms_value3__zc = 0;
    ...
    HIL_OutAO(0x4028, (float)_plant_vs_c_va1__out);
    ...
    _controller_sum1__out = _p_m_a_ref__out + _controller_governor_a__p_prim;
    // Generated from the component: Controller.Sum3
    _controller_sum3__out = _p_m_b_ref__out + _controller_governor_b__p_prim;
    // Generated from the component: Controller.Sum5
    _controller_sum5__out = _p_m_c_ref__out + _controller_governor_c__p_prim;
    ...
    // Generated from the component: Controller.AVR_b
    _controller_avr_b__voltage_non = _constant1__out;
    _controller_avr_b__vs = _controller_rms_value2__out;
    {
        _controller_avr_b__q_prim = _controller_avr_b__e_q * 1 / 0.05 + _controller_avr_b__x_q ;
    }
    ...
    // Generated from the component: Controller.AVR_a
    _controller_avr_a__voltage_non = _constant1__out;
    _controller_avr_a__vs = _controller_rms_value1__out;
    {
        _controller_avr_a__q_prim = _controller_avr_a__e_q * 1 / 0.05 + _controller_avr_a__x_q ;
    }
    ...
    // Generated from the component: Controller.AVR_c
    _controller_avr_c__voltage_non = _constant1__out;
    _controller_avr_c__vs = _controller_rms_value3__out;
    {
        _controller_avr_c__q_prim = _controller_avr_c__e_q * 1 / 0.05 + _controller_avr_c__x_q ;
    }
    // Generated from the component: P_3ph
    HIL_OutAO(0x4016, (float)_power_meter1__Pdc);
    // Generated from the component: Q_3ph
    HIL_OutAO(0x401c, (float)_power_meter1__Qdc);
    // Generated from the component: p_3ph
    HIL_OutAO(0x4024, (float)_power_meter1__Pac);
    // Generated from the component: q_3ph
    HIL_OutAO(0x4025, (float)_power_meter1__Qac);
    ...
    _controller_gain2__out = 3.0 * _controller_sum1__out;
    // Generated from the component: Controller.Gain4
    _controller_gain4__out = 3.0 * _controller_sum3__out;
    // Generated from the component: Controller.Gain6
    _controller_gain6__out = 3.0 * _controller_sum5__out;
    ...
    _controller_sum4__out = _q_s_b_ref__out + _controller_avr_b__q_prim;
    // Generated from the component: Controller.q_prim_b
    HIL_OutAO(0x4014, (float)_controller_avr_b__q_prim);
    // Generated from the component: Controller.Sum2
    _controller_sum2__out = _q_s_a_ref__out + _controller_avr_a__q_prim;
    // Generated from the component: Controller.q_prim_a
    HIL_OutAO(0x4013, (float)_controller_avr_a__q_prim);
    ...
    _controller_sum6__out = _q_s_c_ref__out + _controller_avr_c__q_prim;
    // Generated from the component: Controller.q_prim_c
    HIL_OutAO(0x4015, (float)_controller_avr_c__q_prim);
    ...
    HIL_OutAO(0x401a, (float)_plant_c_function1__f);
    // Generated from the component: Plant.omega_grid
    HIL_OutAO(0x401b, (float)_plant_c_function1__omega);
    // Generated from the component: Controller.Gain5
    _controller_gain5__out = 3.0 * _controller_sum4__out;
    // Generated from the component: Controller.Gain3
    _controller_gain3__out = 3.0 * _controller_sum2__out;
    ...
    _controller_gain7__out = 3.0 * _controller_sum6__out;
    // Generated from the component: Pa
    HIL_OutAO(0x4017, (float)_single_phase_power_meter1_pmult__out);
    ...
    HIL_OutAO(0x4018, (float)_single_phase_power_meter2_pmult__out);
    ...
    HIL_OutAO(0x4019, (float)_single_phase_power_meter3_pmult__out);
    ...
    HIL_OutAO(0x401d, (float)_single_phase_power_meter1_qmult__out);
    // Generated from the component: Qb
    HIL_OutAO(0x401e, (float)_single_phase_power_meter2_qmult__out);
    // Generated from the component: Qc
    HIL_OutAO(0x401f, (float)_single_phase_power_meter3_qmult__out);
...
//@cmp.out.block.end
    ...
    // Generated from the component: Controller.Unit Delay4
    _controller_unit_delay4__state = _controller_vsg_a_c_function_vsg__omega_vsg;
    // Generated from the component: Controller.Unit Delay5
    _controller_unit_delay5__state = _controller_vsg_b_c_function_vsg__omega_vsg;
    // Generated from the component: Controller.Unit Delay6
    _controller_unit_delay6__state = _controller_vsg_c_c_function_vsg__omega_vsg;
    // Generated from the component: Controller.VSG_a.Step1
    if (_controller_vsg_a_step1__state <= 3.0)
    ...
    // Generated from the component: Controller.Governor_a
    {
        _controller_governor_a__e_p = ( _controller_governor_a__omega_nom - _controller_governor_a__omega_vsg ) / 314.1592653589793 ;
        _controller_governor_a__x_p = _controller_governor_a__x_p + 200.0 * 5e-05 * _controller_governor_a__e_p ;
    }
    // Generated from the component: Controller.Governor_b
    {
        _controller_governor_b__e_p = ( _controller_governor_b__omega_nom - _controller_governor_b__omega_vsg ) / 314.1592653589793 ;
        _controller_governor_b__x_p = _controller_governor_b__x_p + 200.0 * 5e-05 * _controller_governor_b__e_p ;
    }
    // Generated from the component: Controller.Governor_c
    {
        _controller_governor_c__e_p = ( _controller_governor_c__omega_nom - _controller_governor_c__omega_vsg ) / 314.1592653589793 ;
        _controller_governor_c__x_p = _controller_governor_c__x_p + 200.0 * 5e-05 * _controller_governor_c__e_p ;
    }
    // Generated from the component: Controller.current_ctrl.Subsystem6.Integrator1
    ...
    // Generated from the component: Controller.RMS value2
    if( _controller_rms_value2__zc ) {
        if (_plant_v_sb_va1__out != _controller_rms_value2__previous_value)
            _controller_rms_value2__correction = - _controller_rms_value2__previous_value / (_plant_v_sb_va1__out - _controller_rms_value2__previous_value);
        if (_controller_rms_value2__correction < 0)
            _controller_rms_value2__correction = 0;
        else
            _controller_rms_value2__correction = 0;
        _controller_rms_value2__sample_cnt += _controller_rms_value2__correction - _controller_rms_value2__previous_correction;
        _controller_rms_value2__out_state = sqrt(_controller_rms_value2__square_sum / _controller_rms_value2__sample_cnt);
        _controller_rms_value2__sample_cnt = 0;
        _controller_rms_value2__previous_correction = _controller_rms_value2__correction;
        _controller_rms_value2__square_sum = 0;
    } else if ( _controller_rms_value2__sample_cnt >= 10000 ) {
        _controller_rms_value2__out_state = sqrt(_controller_rms_value2__square_sum / _controller_rms_value2__sample_cnt);
        _controller_rms_value2__sample_cnt = 0;
        _controller_rms_value2__square_sum = 0;
    }
    _controller_rms_value2__previous_value = _plant_v_sb_va1__out;
    _controller_rms_value2__square_sum += _plant_v_sb_va1__out * _plant_v_sb_va1__out;
    _controller_rms_value2__sample_cnt ++;
    // Generated from the component: Single Phase Power Meter2.Va RMS
    if (_single_phase_power_meter2_va_rms__period_cnt >= 2 * M_PI) {
        _single_phase_power_meter2_va_rms__period_cnt = fmod(_single_phase_power_meter2_va_rms__period_cnt, 2 * M_PI);
    }
    ...
    // Generated from the component: Controller.RMS value1
    if( _controller_rms_value1__zc ) {
        if (_plant_vs_a_va1__out != _controller_rms_value1__previous_value)
            _controller_rms_value1__correction = - _controller_rms_value1__previous_value / (_plant_vs_a_va1__out - _controller_rms_value1__previous_value);
        if (_controller_rms_value1__correction < 0)
            _controller_rms_value1__correction = 0;
        else
            _controller_rms_value1__correction = 0;
        _controller_rms_value1__sample_cnt += _controller_rms_value1__correction - _controller_rms_value1__previous_correction;
        _controller_rms_value1__out_state = sqrt(_controller_rms_value1__square_sum / _controller_rms_value1__sample_cnt);
        _controller_rms_value1__sample_cnt = 0;
        _controller_rms_value1__previous_correction = _controller_rms_value1__correction;
        _controller_rms_value1__square_sum = 0;
    } else if ( _controller_rms_value1__sample_cnt >= 10000 ) {
        _controller_rms_value1__out_state = sqrt(_controller_rms_value1__square_sum / _controller_rms_value1__sample_cnt);
        _controller_rms_value1__sample_cnt = 0;
        _controller_rms_value1__square_sum = 0;
    }
    _controller_rms_value1__previous_value = _plant_vs_a_va1__out;
    _controller_rms_value1__square_sum += _plant_vs_a_va1__out * _plant_vs_a_va1__out;
    _controller_rms_value1__sample_cnt ++;
    // Generated from the component: Single Phase Power Meter1.Va RMS
    if (_single_phase_power_meter1_va_rms__period_cnt >= 2 * M_PI) {
        _single_phase_power_meter1_va_rms__period_cnt = fmod(_single_phase_power_meter1_va_rms__period_cnt, 2 * M_PI);
    }
    ...
    // Generated from the component: Controller.RMS value3
    if( _controller_rms_value3__zc ) {
        if (_plant_vs_c_va1__out != _controller_rms_value3__previous_value)
            _controller_rms_value3__correction = - _controller_rms_value3__previous_value / (_plant_vs_c_va1__out - _controller_rms_value3__previous_value);
        if (_controller_rms_value3__correction < 0)
            _controller_rms_value3__correction = 0;
        else
            _controller_rms_value3__correction = 0;
        _controller_rms_value3__sample_cnt += _controller_rms_value3__correction - _controller_rms_value3__previous_correction;
        _controller_rms_value3__out_state = sqrt(_controller_rms_value3__square_sum / _controller_rms_value3__sample_cnt);
        _controller_rms_value3__sample_cnt = 0;
        _controller_rms_value3__previous_correction = _controller_rms_value3__correction;
        _controller_rms_value3__square_sum = 0;
    } else if ( _controller_rms_value3__sample_cnt >= 10000 ) {
        _controller_rms_value3__out_state = sqrt(_controller_rms_value3__square_sum / _controller_rms_value3__sample_cnt);
        _controller_rms_value3__sample_cnt = 0;
        _controller_rms_value3__square_sum = 0;
    }
    _controller_rms_value3__previous_value = _plant_vs_c_va1__out;
    _controller_rms_value3__square_sum += _plant_vs_c_va1__out * _plant_vs_c_va1__out;
    _controller_rms_value3__sample_cnt ++;
    // Generated from the component: Single Phase Power Meter3.Va RMS
    if (_single_phase_power_meter3_va_rms__period_cnt >= 2 * M_PI) {
        _single_phase_power_meter3_va_rms__period_cnt = fmod(_single_phase_power_meter3_va_rms__period_cnt, 2 * M_PI);
    }
    ...
    // Generated from the component: Controller.AVR_b
    {
        _controller_avr_b__e_q = ( _controller_avr_b__voltage_non - _controller_avr_b__vs ) / 230.0 ;
        _controller_avr_b__x_q = _controller_avr_b__x_q + 200.0 * 5e-05 * _controller_avr_b__e_q ;
    }
    // Generated from the component: Controller.AVR_a
    {
        _controller_avr_a__e_q = ( _controller_avr_a__voltage_non - _controller_avr_a__vs ) / 230.0 ;
        _controller_avr_a__x_q = _controller_avr_a__x_q + 200.0 * 5e-05 * _controller_avr_a__e_q ;
    }
    // Generated from the component: Controller.current_ctrl.C function PLL
    {
    ...
    // Generated from the component: Controller.AVR_c
    {
        _controller_avr_c__e_q = ( _controller_avr_c__voltage_non - _controller_avr_c__vs ) / 230.0 ;
        _controller_avr_c__x_q = _controller_avr_c__x_q + 200.0 * 5e-05 * _controller_avr_c__e_q ;
    }
    // Generated from the component: Plant.C function1
    {
    ...
    // Generated from the component: Controller.VSG_a.C function VSG
    {
        ...
        _controller_vsg_a_c_function_vsg__x_q = _controller_vsg_a_c_function_vsg__x_q + 10.0 * 5e-05 * _controller_vsg_a_c_function_vsg__e_q ;
    ...
    // Generated from the component: Controller.VSG_b.C function VSG
    {
        ...
        _controller_vsg_b_c_function_vsg__x_q = _controller_vsg_b_c_function_vsg__x_q + 10.0 * 5e-05 * _controller_vsg_b_c_function_vsg__e_q ;
    ...
    // Generated from the component: Controller.VSG_c.C function VSG
    {
        ...
        _controller_vsg_c_c_function_vsg__x_q = _controller_vsg_c_c_function_vsg__x_q + 10.0 * 5e-05 * _controller_vsg_c_c_function_vsg__e_q ;
